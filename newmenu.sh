...
Exp=$(curl -sS https://raw.githubusercontent.com/anzclan/USER-REG/main/ipvps | grep $MYIP | awk '{print $3}')
fi
chck_b(){
...
curl -sS https://raw.githubusercontent.com/anzclan/scvpnme/main/clgshow
echo -e "
"
fi
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
