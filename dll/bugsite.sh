...
clear
bugdigi=/root/.scvpn/.bugsite/digi
bugumo=/root/.scvpn/.bugsite/umobile
bugmaxis=/root/.scvpn/.bugsite/maxis
bugunifi=/root/.scvpn/.bugsite/unifi
bugyodoo=/root/.scvpn/.bugsite/yodoo
bugcelcom=/root/.scvpn/.bugsite/celcom
installed=/root/.scvpn/.bugsite/install
...
echo 'scvpn.me' >$bugdigi
echo 'scvpn.me' >$bugumo
echo 'scvpn.me' >$bugmaxis
echo 'scvpn.me' >$bugunifi
echo 'scvpn.me' >$bugyodoo
echo 'scvpn.me' >$bugcelcom
echo 'done' >$installed
clear
bugsite
fi
