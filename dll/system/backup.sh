...
LLatest=`date`
Get_Data () {
git clone https://github.com/anzclan/user-backup-db.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git push -f https://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@github.com/anzclan/LOG-USER.git &> /dev/null
}
...
link="https://raw.githubusercontent.com/anzclan/user-backup-db/main/$NameUser/$NameUser.zip"
sleep 1
