...
dircreate
        ...
        echo -ne "Username admin panel use '@' [Ex: @anzclan] : "
        read admin_pnl
        [[ -z $admin_pnl ]] && admin_pnl="@anzclan"
        echo ""
...
EOF
        ...
        fun_bot1() {
            [[ ! -e "/etc/.maAsiss/.Shellbtsss" ]] && {
				wget -qO- https://raw.githubusercontent.com/anzclan/scvpnme/main/dll/system/ShellBot.sh >/etc/.maAsiss/.Shellbtsss
			}
