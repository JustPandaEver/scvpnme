...
curl -sS https://raw.githubusercontent.com/anzclan/scvpnme/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
# set time GMT +08
sleep 1
echo -e "[ ${green}INFO$NC ] Set zone local time to Asia/Kuala_Lumpur GMT+08"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/anzclan/scvpnme/main/ssh/newudpgw"
...
# install squid
cd
curl -sS "https://raw.githubusercontent.com/anzclan/scvpnme/main/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/squid/squid.conf
...
wget -q https://raw.githubusercontent.com/anzclan/scvpnme/main/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/anzclan/scvpnme/main/banner/issue.net"
...
mkdir /root/.scvpn
mkdir /root/.scvpn/.bugsite
echo 'scvpn.me' > /root/.scvpn/.bugsite/digi
echo 'scvpn.me' > /root/.scvpn/.bugsite/umobile
echo 'scvpn.me' > /root/.scvpn/.bugsite/maxis
echo 'scvpn.me' > /root/.scvpn/.bugsite/unifi
echo 'scvpn.me' > /root/.scvpn/.bugsite/yodoo
echo 'scvpn.me' > /root/.scvpn/.bugsite/celcom
echo 'done' > /root/.scvpn/.bugsite/install
